...
| TC-01 | Register User Already Exists | POST/{{baseUrl}}/auth/register | 409 | 409  | PASS|
| TC-02 | Register User type |  POST/{{baseUrl}}/auth/register | 400 | 400 | PASS |
| TC-03 | Register User role remove |  POST/{{baseUrl}}/auth/register | 400 | 400 | PASS |
| TC-04 | Register User password short |  POST/{{baseUrl}}/auth/register | 400 | 400 | PASS |
| TC-05 | Login User | Post/{{baseUrl}}/auth/login  | 200 | 200| PASS |
| TC-06 | Login User wrong pass | Post/{{baseUrl}}/auth/login | 401 | 401 | PASS/Fail |
| TC-07 | Login User not exist |  Post/{{baseUrl}}/auth/login | 401 | 401 | PASS/Fail |
| TC-08| Login User Missing Credentials|  Post/{{baseUrl}}/auth/login  | 400 | 400 | PASS/Fail |
